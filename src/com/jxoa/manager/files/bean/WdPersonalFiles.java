...
public class WdPersonalFiles implements java.io.Serializable {
	...
	/** default constructor */
	public WdPersonalFiles() {
	}

	/** minimal constructor */
	public WdPersonalFiles(String wdSuperId, String wdName, String wdUserId,
