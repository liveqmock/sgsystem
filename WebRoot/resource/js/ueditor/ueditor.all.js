...
(function () {
    ...
    var iframeUrlMap = {
       ...
       //'highlightcode':'~/dialogs/highlightcode/highlightcode.html',
        ...
        'addinput':'~/dialogs/mydialog/addinput.html',
    };
    ...
    var btnCmds = ['undo', 'redo', 'formatmatch',
        ...
        'deletecol', 'splittorows', 'splittocols', 'splittocells', 'mergecells', 'deletetable','addinput'];
    ...
    var dialogBtns = {
        ...
        ok:['attachment', 'anchor', 'link', 'insertimage', 'map', 'gmap', 'insertframe', 'wordimage',
            'insertvideo', 'insertframe', 'edittip', 'edittable', 'edittd', 'scrawl', 'template', 'music', 'background',"addinput"]
