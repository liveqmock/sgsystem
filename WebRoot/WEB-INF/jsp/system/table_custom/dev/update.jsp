...
<form method="post" action="tableCustom/dev/update.do" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone)">
	...
	<div class="pageFormContent nowrap" style="padding-left:50px;"  layoutH="58">
			...
			<dl>
				<dt>属性名称：</dt>
				<dd>
					<input type="text" name="fieldName"    maxlength="30" class="required"  size="25" value="<c:out value="${requestScope.tc.fieldName }" />"/>
			...
			<dl>
				<dt>属性类型：</dt>
				<dd>
					<select class="combox"  name="fieldType" sValue="${requestScope.tc.fieldType }">
			...
			<dl>
				<dt>显示名：</dt>
				<dd>
					<input type="text" name="fieldTitle" class="required"  maxlength="20" size="25" value="<c:out value="${requestScope.tc.fieldTitle }" />"/>
