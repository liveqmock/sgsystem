...
<body>
	<div class="al_page">
		...
		<div class="content_main">
			<!--左边页面-->
			<iframe src="../web/dwzpleft.do" class="let_pages" frameborder=0
				scrolling=no></iframe>
			<!--右边页面-->
			<div class="rgt_page">
				<!--导航-->
				...
				<div class="lab_page_cs" id="gzdt">论坛</div>
				<div class="move_div"></div>
				<a href="#"><div class="more_page_cs" id="gd">首页>>居民论坛>>详情</div> </a>
				<iframe src="forumdetail.do?id=${id }" class="tu_name" style="margin: 0px;"
					width="890" height="700" frameborder=0 scrolling=no
					></iframe>
			</div>
		</div>
		<!--动态-->
