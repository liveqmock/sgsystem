...
<div class="pageContent" align="center">
	...
	<form method="post" action="personalFiles/update.do" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone)">
		...
		<div class="pageFormContent nowrap" style="padding-left:50px;"  layoutH="58">
				...
				<div class="unit">
					<label>备注：</label>
					<textarea  name="wdDesc" cols="30" rows="2" maxlength="50"><c:out value="${requestScope.f.wdDesc}" /></textarea>
