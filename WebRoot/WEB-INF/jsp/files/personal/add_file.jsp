...
<form method="post" action="personalFiles/addFile.do" enctype="multipart/form-data"   class="pageForm required-validate" onsubmit="return iframeCallback(this,dialogAjaxDone)">
