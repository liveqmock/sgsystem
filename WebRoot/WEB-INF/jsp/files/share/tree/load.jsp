	...
	<div class="tabs">
		<div class="tabsHeader">
			<div class="tabsHeaderContent">
				<ul>
					<li><a href="javascript:;"><span>共享文档管理</span></a></li>
		...
		<div class="tabsContent">
			...
			<div fillSpace="sidebar" >
				...
				<div layoutH="44" style="float:left; display:block; overflow:auto; width:270px; border:solid 1px #CCC;line-height:21px; background:#fff;margin-right: 5px;">
				  	...
				  	<ul id="shareFiles_tree" class="ztree"></ul>
	...
	$.ajax({
		...
		success:function(json){
			...
			$.each(json, function(i, d) {
				...
				zNodes.push({id : d.id,name : d.name,pId : d.pId,href:"shareFiles/tree/query.do?wdSuperId="+d.id+"&rel="+rel+"_box",dwzTarget:"ajax",
					rel:rel+"_box",open:true});
				
			});
			
			$.fn.zTree.init($("#shareFiles_tree"), setting, zNodes);
