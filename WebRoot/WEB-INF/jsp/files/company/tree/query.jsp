...
<div class="pageHeader" style="border:1px #B8D0D6 solid;" >
	<form id="pagerForm" onsubmit="return divSearch(this, '${param.rel}');" action="companyFiles/tree/query.do" method="get">
	...
	<div class="panelBar">
		 <ul class="toolBar">
				...
				<my:validationAuthority url="companyFiles/addFilePage.do">
					<li><a class="add" href="companyFiles/addFilePage.do?id=${param.wdSuperId }&rel=${param.rel}&reType=rel" target="dialog" width="800" height="300" rel="${param.rel}_addnode"><span>创建文件</span></a></li>
					<li class="line">|</li>
				</my:validationAuthority>
				<my:validationAuthority url="companyFiles/updatePage.do">
					<li><a class="edit" href="companyFiles/updatePage.do?id={id}&rel=${param.rel}&reType=rel" target="dialog" width="800" height="300" rel="${param.rel}_update" warn="请先选择文件或文件夹！"><span>修改</span></a></li>
					<li class="line">|</li>
				</my:validationAuthority>
				<my:validationAuthority url="companyFiles/delFile.do">
					<li><a class="delete" href="companyFiles/delFile.do?rel=${param.rel}" target="selectedTodo" rel="ids" title="确定要删除吗?" warn="至少选择一个文件"><span>批量删除文件</span></a></li>
				</my:validationAuthority>
			</ul>
		</div>
			...
			<c:forEach var="m" items="${requestScope.files }" >
				...
				<tr target="id" rel="${m.id }">
						...
						<td>
							...
							<my:validationAuthority url="companyFiles/updatePage.do">
								<a class="btnEdit" href="companyFiles/updatePage.do?id=${m.id}&rel=${param.rel}&reType=rel" target="dialog" width="800" height="300" rel="${param.rel}_update" >修改</a></li>
							</my:validationAuthority>
							<my:validationAuthority url="companyFiles/delFile.do">
								<a class="btnDel" href="companyFiles/delFile.do?ids=${m.id }&rel=${param.rel}" target="ajaxTodo"  title="确定要删除文件吗?" >删除文件</a>
							</my:validationAuthority>
						</td>
