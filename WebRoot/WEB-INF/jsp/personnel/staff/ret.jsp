...
<div class="pageContent" style="padding: 1px">
	...
	<form id="pagerForm" onsubmit="return divSearch(this, '${param.rel }_ret');;" action="staff/ret.do" method="get">
		<div class="searchBar">
			...
			<div class="searchBar">
				<table class="searchContent" style="margin-left:5px">
					<tr >
						...
						<td><a class="button" href="staff/searchTag.do?search=ret" width="800" height="400" target="dialog" mask="true" rel="${param.rel }" title="查询框"><span>高级检索</span></a></td>
...
<%--					</li>--%>
					...
					<li>
						<a class="delete" href="staff/del.do?rel=${param.rel}_ret" target="selectedTodo"
					...
					<li>
						<a class="edit" href="staff/updateStatusPage.do?id={id}&rel=${param.rel}_ret"  width="800" height="450"  target="dialog"
			...
			<table class="table" width="1100" layoutH="154" rel="${param.rel }_ret">
				<thead>
					<tr>
						...
						<th width="140" align="center" orderField="psRetDate"  class="${fromParam.orderDirection}">退休时间</th>
						<th width="342" align="center">退休原因</th>
					</tr>
				</thead>
				<tbody>
					<c:forEach var="v" items="${valuesRet }">
						...
						<tr target="id" rel="${v.id }">
							...
							<td
								title="<fmt:formatDate value="${v.psRetDate}" pattern="yyyy-MM-dd" />">
								<fmt:formatDate value="${v.psRetDate}"
									pattern="yyyy-MM-dd" />
							</td>
							
							<c:forEach var="me" items="${applicationScope.type2ListValues.type_15}" >
							<c:if test="${v.psRetReason==me.value }">
			...
			<div class="panelBar">
							<div class="pages">
			<span>显示&nbsp;</span>
			<select class="combox"   name="numPerPage"  onchange="navTabPageBreak({numPerPage:this.value}, '${param.rel }_ret')"  sValue="${requestScope.fromParam.numPerPage}" >
		...
		<div class="pagination" rel="${param.rel }_ret"  totalCount="<c:out  value="${requestScope.fromParam.allCount }" default="0"/>" numPerPage="${requestScope.fromParam.numPerPage}" pageNumShown="${requestScope.fromParam.pageNumShown }" currentPage="${requestScope.fromParam.pageNum}"></div>
