...
<%--
	模块：公各平台--新闻管理更新页面
--%>
<form method="post" action="message/update.do"  class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone)">
<div class="pageContent" >
	<div class="pageFormContent nowrap" style="padding-left:10px;"  layoutH="56">
			...
			<dt>
				...
				<dd>
					<textarea  name="replycontent" class="required combox" cols="70" rows="5" maxlength="255" disabled >${message.replycontent}</textarea>
				</dd>
			</dl>
		...
		<div class="formBar">
			<ul style="float: left;margin-left: 30%;">
				<li><div class="buttonActive"><div class="buttonContent"><button type="submit" disabled >提交 </button></div></div></li>
