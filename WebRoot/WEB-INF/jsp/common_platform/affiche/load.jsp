...
<div class="pageHeader">
	<form id="pagerForm" onsubmit="return navTabSearch(this);" action="affiche/load.do" method="post">
		<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<my:validationAuthority url="affiche/addPage.do">
				<li><a class="add" href="affiche/addPage.do?rel=${param.rel }" target="navTab" rel="${param.rel}_add"><span>添加</span></a></li>
				<li class="line">|</li>	
			</my:validationAuthority>
			<my:validationAuthority url="affiche/updatePage.do">
				<li><a class="edit" href="affiche/updatePage.do?id={id}&rel=${param.rel}" target="navTab" rel="${param.rel}_update" ><span>修改</span></a></li>
				<li class="line">|</li>
			</my:validationAuthority>
			<my:validationAuthority url="affiche/del.do">
				<li><a class="delete" href="affiche/del.do" target="selectedTodo" rel="ids" title="确定要删除吗?" ><span>批量删除</span></a></li>
			</my:validationAuthority>
		</ul>
	</div>
