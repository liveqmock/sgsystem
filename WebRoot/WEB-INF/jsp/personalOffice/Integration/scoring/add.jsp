	...
	<form method="post" action="scoringMonth/add.do"
		...
		<div class="pageFormContent nowrap"
			...
			<dl style="margin-top: 30px;">
				...
				<dd>
				<input type="text" name="deSort" value="${roName }" readonly="readonly" size="50">
				</dd>
			</dl>
			<dl>
				<dt>
				...
				<dd>
					...
					<input type="hidden" readonly="readonly" name="deStaff" toName="user.id"  class="clear_user" />
				...
				<dd>
					<select id="inputOrg1" class="combox required"  name="deGroup" >
...
<%--					<input type="hidden" readonly="readonly" name="smStaff" toName="as.id"  class="clear_user" />--%>
			...
			<dl>
				...
				<dd>
					<input type="text" class="readonly" name="deMinute" toName="as.minute" size="50"/>
				</dd>
			</dl>
			<dl>
				<dt>
