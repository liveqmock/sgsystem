...
<div class="pageHeader">
	<form id="pagerForm" onsubmit="return divSearch(this,'${param.rel}_an');" action="detail/queryCH.do" method="get">
		<div class="searchBar">
	...
	<div class="panelBar">
		<ul class="toolBar">
			...
			<my:validationAuthority url="detail/anti.do">
				<li><a class="delete" href="detail/anti.do?rel=${param.rel }_an" target="selectedTodo" rel="ids" title="确定要批量反审核吗?" warn="至少选择一条记录"><span>批量反审核</span></a></li>
			</my:validationAuthority>
			
		</ul>
	</div>
	<table class="table" width="1125" layoutH="154"  rel="${param.rel }_an" >
		<thead>
			<tr>
