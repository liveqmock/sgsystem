...
<div class="pageHeader" style="border:1px #B8D0D6 solid;" >
	...
	<form id="pagerForm" onsubmit="return divSearch(this, '${param.rel }_isread');" action="msgwarn/load/isread.do" method="post">
		...
		<div class="searchBar">
			<table class="searchContent" style="margin-left: 50px">
				<tr >
					...
					<td><div class="button"><div class="buttonContent"><button type="button" formreset="reset"  resetClass="">重置</button></div></div></td>
				</tr>
			</table>
		</div>
	</form>
...
<div class="pageContent" style="border-left:1px #B8D0D6 solid;border-right:1px #B8D0D6 solid;">
	<div class="panelBar">
		 <ul class="toolBar">
		 		<my:validationAuthority url="msgwarn/del.do">
		 			<li><a class="delete" href="msgwarn/del.do?rel=${param.rel }_isread" target="selectedTodo" rel="ids" title="确定要删除吗?" ><span>批量删除</span></a></li>
				</my:validationAuthority>
				
			</ul>
		</div>
	<table class="table" width="1000" layoutH="156" rel="${param.rel }_isread">
		<thead>
			<tr>
	...
	<div class="panelBar">
		<div class="pages">
			<span>显示&nbsp;</span>
			<select class="combox"   name="numPerPage"  onchange="navTabPageBreak({numPerPage:this.value}, '${param.rel }_isread')"  sValue="${requestScope.fromParam.numPerPage}" >
		...
		<div class="pagination" rel="${param.rel }_isread"  totalCount="<c:out  value="${requestScope.fromParam.allCount }" default="0"/>" numPerPage="${requestScope.fromParam.numPerPage}" pageNumShown="${requestScope.fromParam.pageNumShown }" currentPage="${requestScope.fromParam.pageNum}"></div>
	</div>
</div>					
