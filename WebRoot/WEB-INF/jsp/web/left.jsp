	...
	<div>
		<div class="let_page">
						...
						<tr>
							<td colspan="3"><input type="submit" value=""
								style="background-image:url(images/login.png);width: 85px;height: 26px;border: 0;background-repeat: no-repeat;cursor:pointer;margin-left:34px; ">&nbsp;&nbsp;
								 <input type="button" onclick="fun()"  target="_blank"   style="background-image:url(images/regist.png);width: 85px;height: 26px;border: 0;background-repeat: no-repeat;cursor:pointer;">
							</td>
						</tr>
					</tbody>
				</table>
			...
			<div class="biaoge_div_css">
				...
				<div>
					<div class="tab_div">
						<div class="tab_div_name">表格下载</div>
						<div class="tab_div_more">更多</div>
					</div>
					<div class="tab_div_content">
						<div>学习实践科学发展观征询公众意见</div>
						<div>学习实践科学发展观征询公众意见</div>
						<div>学习实践科学发展观征询公众意见</div>
						<div>学习实践科学发展观征询公众意见</div>
						<div>学习实践科学发展观征询公众意见</div>
...
//window.open("dwzp.do?bz=rigistload");
//	window.location.href="web/dwzp.do?bz=rigistload";
//	window.parent.document.getElementById("rightframe").src="web/rigistload.do";
//	window.parent.document.getElementById("gzdt").innerHTML="用户注册";
//	window.parent.document.getElementById("gd").innerHTML="";
}
</script>
