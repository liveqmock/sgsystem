...
<body>
	<div class="al_page">
		...
		<div class="content_main">
			<!--左边页面-->
			<iframe src="dwzpleft.do" class="let_pages" frameborder=0
				scrolling=no></iframe>
			<!--右边页面-->
			<div class="rgt_page">
				<!--导航-->
				...
				<div class="lab_page_cs" id="gzdt">工作动态</div>
				<div class="move_div"></div>
				<a href="#"><div class="more_page_cs" id="gd">更多</div> </a>
				<iframe src="${requestScope.bz}" class="tu_name" style="margin: 0px;"
