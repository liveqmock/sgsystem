...
<div class="pageContent" >
	<div class="pageFormContent nowrap" style="padding-left:10px;"  layoutH="56">
			...
			<dt>
				...
				<dd>
					<textarea  name="responseContent" class="required combox" cols="70" rows="5" maxlength="255" <c:if test="${question.questionStatus=='1'}">disabled</c:if> >${question.responseContent}</textarea>
				</dd>
			</dl>
		...
		<div class="formBar">
			<ul style="float: left;margin-left: 30%;">
				<li><div class="buttonActive"><div class="buttonContent"><button type="submit" <c:if test="${question.questionStatus==1}">disabled</c:if> >提交 </button></div></div></li>
