...
<form method="post" action="dwzp/update.do" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone)">
	<div class="pageFormContent"
			...
			<dt width="10%">单位名称：</dt>
				<dd>
					<input type="text"  name="dwmc" id ="dwmc" value ="${requestScope.r.dwmc }"   />
			...
			<dt width="10%">单位地址：</dt>
				 <dd>
				<input type="text"  name="dwdz" id ="dwdz" value ="${requestScope.r.dwdz }"  />
				 </dd>
				</dl>
				<dl>
				<dt width="10%">需求岗位：</dt>
				 <dd>
				 	<input type="text"  name="xqgw" id ="xqgw" value ="${requestScope.r.xqgw }"   />
				 </dd>
				 </dl>
			<dl>
				<dt >需求人数：</dt>
				 <dd>
				 	<input type="text"  name="xqrs" id ="xqrs" value ="${requestScope.r.xqrs }"  class="number" />
				 </dd>
		  </dl>
		  <dl>
			<dt >性别要求：</dt>
				 <dd>
				 	<select name="xbyq" id="xbyq"  >
				...
				<dt >薪金待遇：</dt>
				 <dd>
				 	<input type="text"  name="xzdy" id ="xzdy" value ="${requestScope.r.xzdy }"  class="number" />
				 </dd>
		  </dl>
				  	<dl>
				<dt >联系人：</dt>
				 <dd>
				 	<input type="text"  name="lxr" id ="lxr" value ="${requestScope.r.lxr }"   />
				 </dd>
		  </dl>
		  	  	<dl>
				<dt >联系人电话：</dt>
				 <dd>
				 	<input type="text"  name="lxrdh" id ="lxrdh" value ="${requestScope.r.lxrdh }"   />
				 </dd>
		  </dl>
